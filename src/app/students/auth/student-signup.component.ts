      ...
      <form #signupForm="ngForm" (ngSubmit)="onSubmit(signupForm)">
        ...
        <div class="form-group">
          ...
          <input
            ...
            [class.error]="confirmPasswordInput.value !== studentData.password && confirmPasswordInput.touched">
          <div *ngIf="confirmPasswordInput.value !== studentData.password && confirmPasswordInput.touched" class="error-message">
            Passwords do not match
          </div>
        </div>

        <button type="submit" [disabled]="signupForm.invalid || confirmPasswordInput.value !== studentData.password">
          Sign Up
        </button>
      </form>
